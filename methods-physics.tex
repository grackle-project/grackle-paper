...
\begin{enumerate}
\item Collisional excitation cooling rates involving the following species: $n_e n_H$, $n_e^2 n_{He}$, and $n_e n_{He^+}$ \citep{1981MNRAS.197..553B, 1992ApJS...78..341C};
\item Collisional ionization cooling for $n_e n_H$, $n_e n_{He}$, $n_e n_{He^+}$ and $n_e^2 n_{He^+}$ \citep{1987ApJ...318...32S, 1992ApJS...78..341C, 1997NewA....2..181A};
\item Recombination cooling: $n_e n_{H^+}$, $n_e n_{He^+}$, $n_e n_{He^{++}}$ \citep{1981MNRAS.197..553B, 1978ppim.book.....S};
