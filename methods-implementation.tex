...
Adding new rates to Grackle involves modifying the values stored in
...
model then the process is relatively straight forward: grackle reads
...
required. Grackle assumes that non-equilibrium cooling models are
